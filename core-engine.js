...
function importState(event) {
  ...
  reader.onload = function(e) {
    try {
      ...
      // ValidaÃ§Ã£o flexÃ­vel: deve ter pelo menos accounts ou expenses
      if (!imported.expenses && !imported.accounts) throw new Error("Ficheiro JSON nÃ£o parece ser um backup vÃ¡lido deste sistema.");
      
      if (confirm("Tens a certeza? Isto irÃ¡ substituir todos os teus dados atuais e recarregar a pÃ¡gina com o backup escolhido.")) {
        // 1. Guardar os novos dados
        localStorage.setItem(STORAGE_KEY, JSON.stringify(imported));
        
        // 2. Marcar como a versÃ£o mais recente para o Firebase nÃ£o a sobrepor
        // Definimos o last_firebase_sync para AGORA, assim a Cloud (que Ã© antiga) nÃ£o ganha
